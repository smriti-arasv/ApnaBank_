...
<nav id="navbar">
                    ...
                    <table class="table table-hover table-sm  table-condensed table-bordered"
                        ...
                        <tbody>
                            ...
                            <tr style="color : black;">
                                ...
                                <td class="text-center"><a href="selecteduserdetail.php?id= <?php echo $rows['id']; ?>">
                                        <button class="btn btn-primary">Transact</button></a></td>
                            </tr>
                            <?php
                            }
                            ?>
    ...
    <footer class="text-center mt-5 py-2">
            <p style="font-family: poppins; font-size: 16px;">&copy 2021. Created by <b>Smriti Kumari </b> <br> The Sparks Foundation</p>
        </footer>
